...
def reboot_required_message(version: str) -> str:
    ...
    return (
        ...
        "Для перезагрузки выполните следующие шаги:\n"
        "1. Откройте <a href='developer-tools/yaml'>Панель разработчика</a>\n"
        "2. Нажмите <font color='red'>Перезапустить</font>\n"
        "3. Выберите Дополнительные опции\n"
        "4. Нажмите Перезагрузить систему"
    )